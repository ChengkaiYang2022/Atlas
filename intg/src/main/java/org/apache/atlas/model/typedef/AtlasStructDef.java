...
public class AtlasStructDef extends AtlasBaseTypeDef implements Serializable {
     ...
     * @param typeVersion 类型版本
     * @param attributeDefs 类型属性列表
     * @param serviceType ?
     * @param options 可选
     */
    ...
    public static class AtlasAttributeDef implements Serializable {
        ...
        /**
         * 名称、类型名称、是否必须、?、最小值、最大值、是否唯一、是否可索引、是否在Notification中、默认值、描述
         */
        private String                   name;
        ...
        /**
         * @param name 类型属性名称
         * @param typeName 类型属性数据结构
         * @param isOptional 是否必须
         * @param cardinality 基类是单一，列表还是散列表
         * @param valuesMinCount 最小值
         * @param valuesMaxCount 最大值
         * @param isUnique 是否唯一
         * @param isIndexable 是否可索引
         * @param includeInNotification 是否在Notification中
         * @param constraints
         */
        public AtlasAttributeDef(String name, String typeName, boolean isOptional, Cardinality cardinality,
